...
class UiMainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.copy_join_keys.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_copy_join_keys.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.copy_share_keys.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_copy_share_keys.sizePolicy().hasHeightForWidth())
...
"text-align: center;")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.client_name.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_client_name.sizePolicy().hasHeightForWidth())
        ...
        self.label_client_name_for_sync.setGeometry(QtCore.QRect(23, 90, 141, 31))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_client_name_for_sync.sizePolicy().hasHeightForWidth())
        ...
        self.label_client_name_for_sync.setObjectName("label_client_name_for_sync")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.client_name_for_sync.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.connector_enter_keys.sizePolicy().hasHeightForWidth())
        ...
        self.label_connector_enter_keys.setGeometry(QtCore.QRect(24, 240, 141, 31))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_connector_enter_keys.sizePolicy().hasHeightForWidth())
        ...
        self.label_connector_enter_keys.setObjectName("label_connector_enter_keys")
        self.label_connector_space_bar_keys = QtWidgets.QLabel(self.centralwidget)
        self.label_connector_space_bar_keys.setGeometry(QtCore.QRect(181, 240, 141, 31))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_connector_space_bar_keys.sizePolicy().hasHeightForWidth())
        ...
        self.label_connector_space_bar_keys.setObjectName("label_connector_space_bar_keys")
        self.connector_space_bar_keys = QtWidgets.QLineEdit(self.centralwidget)
        self.connector_space_bar_keys.setGeometry(QtCore.QRect(176, 270, 151, 31))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.connector_space_bar_keys.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.connector_none_keys.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_connector_none.sizePolicy().hasHeightForWidth())
        ...
        self.label_client_name_for_share.setGeometry(QtCore.QRect(181, 90, 141, 31))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_client_name_for_share.sizePolicy().hasHeightForWidth())
        ...
        self.label_client_name_for_share.setObjectName("label_client_name_for_share")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.client_name_for_share.sizePolicy().hasHeightForWidth())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_port.setText(_translate("MainWindow", "<html><head/><body><p>Порт</p></body></html>"))
        self.copy_join_keys.setPlaceholderText(_translate("MainWindow", " <ctrl>+<shift>+c"))
        self.label_copy_join_keys.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt;\">Копирование +</span></p></body></html>"))
        self.copy_share_keys.setPlaceholderText(_translate("MainWindow", " <ctrl>+<alt>+p"))
        self.label_copy_share_keys.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt;\">Поделиться</span></p></body></html>"))
        self.label_error.setText(_translate("MainWindow", "<html><head/><body><p/></body></html>"))
        self.client_name.setPlaceholderText(_translate("MainWindow", " Ваше имя *"))
        self.label_client_name.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt;\">Имя</span></p></body></html>"))
        self.label_client_name_for_sync.setText(_translate("MainWindow", "<html><head/><body><p>Синхронизация</p></body></html>"))
        self.client_name_for_sync.setPlaceholderText(_translate("MainWindow", "Имя клиента"))
        self.connector_enter_keys.setPlaceholderText(_translate("MainWindow", " <ctrl>+1"))
        self.label_connector_enter_keys.setText(_translate("MainWindow", "<html><head/><body><p>Новая строка</p></body></html>"))
        self.label_connector_space_bar_keys.setText(_translate("MainWindow", "<html><head/><body><p>Пробел</p></body></html>"))
        self.connector_space_bar_keys.setPlaceholderText(_translate("MainWindow", " <ctrl>+2"))
        self.connector_none_keys.setPlaceholderText(_translate("MainWindow", " <ctrl>+3"))
        self.label_connector_none.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt;\">Слитно</span></p></body></html>"))
        self.label_client_name_for_share.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt;\">Делиться c:</span></p></body></html>"))
        self.client_name_for_share.setPlaceholderText(_translate("MainWindow", "Имя клиента"))
...
class ShowUiMainWindow(QtWidgets.QMainWindow):
    ...
    def _set_settings(self, settings: app_settings.AppSettings, update=True):
        ...
        self.ui.copy_share_keys.setText(settings.copy_share_keys)
        self.ui.connector_space_bar_keys.setText(
            settings.connector_space_bar_keys)
        self.ui.connector_enter_keys.setText(settings.connector_enter_keys)
    ...
    def apply_parameters(self) -> None:
        ...
        new_settings = app_settings.AppSettings(
            ...
            copy_share_keys=self.ui.copy_share_keys.text(),
            connector_space_bar_keys=self.ui.connector_space_bar_keys.text(),
            connector_enter_keys=self.ui.connector_enter_keys.text(),
